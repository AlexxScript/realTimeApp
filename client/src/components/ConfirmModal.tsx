    ...
    return (
        <div className={`bg-slate-800 bg-opacity-50 flex justify-center items-center top-0 right-0 bottom-0 left-0 flex-1 ${props.modal.modal ? "fixed" : "hidden"}`}>
            <div className="bg-white px-16 py-14 rounded-md text-center">
                ...
                <button onClick={() => props.handleWindowModal(props.modal.itemName,props.modal.idItem)} className="bg-[#f7b267] px-4 py-2 rounded-md text-md text-white">Cancel</button>
